...
const services = [
  { icon: Plane, title: "Air Freight", desc: "Express international air cargo with 48–72h delivery to major hubs.", img: SITE_IMAGES.airFreight },
  { icon: Ship, title: "Sea Freight", desc: "FCL & LCL ocean shipping with global port-to-port coverage.", img: SITE_IMAGES.seaFreight },
  { icon: Truck, title: "Road Transport", desc: "Cross-border trucking and last-mile delivery across the Americas and EU.", img: SITE_IMAGES.roadTransport },
  { icon: Warehouse, title: "Warehousing", desc: "Secure bonded warehousing, fulfillment, and inventory management.", img: SITE_IMAGES.warehousing },
  { icon: FileCheck, title: "Customs Clearance", desc: "Licensed brokers handling documentation, duties, and compliance.", img: SITE_IMAGES.customsClearance },
  { icon: Globe2, title: "Project Cargo", desc: "Heavy-lift, oversized, and specialized industrial freight solutions.", img: SITE_IMAGES.hero },
];
...
function HomePage() {
  ...
  return (
    <SiteLayout>
      {/* Hero */}
      <section className="relative text-primary-foreground overflow-hidden min-h-[88vh] flex items-center">
        {/* Background image with Ken Burns */}
        <div className="absolute inset-0 overflow-hidden">
          <img
            src={SITE_IMAGES.hero}
            alt="Multimodal global logistics — ship, plane, and trucks"
        ...
        <div className="container mx-auto px-4 lg:px-8 py-24 lg:py-36 relative">
          <div className="max-w-3xl">
            <Reveal from="up">
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-medium tracking-wide mb-5 backdrop-blur">
                <ShieldCheck className="h-3.5 w-3.5 text-gold" /> Trusted by 12,000+ businesses worldwide
              </span>
            </Reveal>

            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.05] text-balance min-h-[2.4em]">
              <Reveal from="up" delay={120}>
                <span className="block">Premium Global Cargo,</span>
              </Reveal>
              <span className="block bg-gold-gradient bg-clip-text text-transparent">
                <Typewriter text="Delivered with Precision." speed={70} delay={900} />
              </span>
            </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => (
            <Reveal key={s.title} from="up" delay={i * 90}>
              <Card className="group hover:shadow-elegant transition-all duration-500 hover:-translate-y-2 border-border/60 overflow-hidden h-full">
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 h-12 w-12 rounded-xl bg-white/95 backdrop-blur flex items-center justify-center shadow-elegant">
                    <s.icon className="h-6 w-6 text-primary" />
                  </div>
                  <span className="absolute top-4 right-4 text-[10px] uppercase tracking-wider font-semibold px-2.5 py-1 rounded-full bg-gold text-gold-foreground">
                    Premium
                  </span>
                </div>
                <CardContent className="p-7">
                  ...
                  <Link to="/services" className="inline-flex items-center gap-1 mt-4 text-sm font-semibold text-primary hover:text-gold transition-colors">
        ...
        <div className="container mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  <Reveal key={f.t} from="left" delay={i * 80}>
          ...
          <Reveal from="left">
            <div className="relative">
              <div className="aspect-[4/5] rounded-3xl shadow-elegant overflow-hidden relative">
                <img
                  src={SITE_IMAGES.seaFreight}
      ...
      <section className="container mx-auto px-4 lg:px-8 py-20 lg:py-28">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <Reveal key={t.n} from="up" delay={i * 100}>
              <Card className="border-border/60 h-full hover:shadow-elegant transition-all hover:-translate-y-1">
                <CardContent className="p-7">
      ...
      <section className="container mx-auto px-4 lg:px-8 pb-24">
        <Reveal from="up">
          <div className="rounded-3xl bg-hero-gradient text-primary-foreground p-10 lg:p-16 shadow-elegant relative overflow-hidden">
            <div className="absolute -right-20 -top-20 h-80 w-80 rounded-full bg-gold/20 blur-3xl animate-float-slow" />
